CarrierWave.configure do |config|
  ...
  config.aliyun_access_id  = CarrierwaveSetting.aliyun.access_id
  config.aliyun_access_key = CarrierwaveSetting.aliyun.access_key
  # 你需要在 Aliyun OSS 上面提前创建一个 Bucket
  # You must create a Bucket on Alicloud OSS first.
  config.aliyun_bucket     = CarrierwaveSetting.aliyun.bucket
  ...
  config.aliyun_internal   = CarrierwaveSetting.aliyun.internal
  ...
  config.aliyun_host       = CarrierwaveSetting.aliyun.host
