...
class ProductMeasurementUnit < ApplicationRecord
  ...
  def self.create_by_params(params)
    ...
    response = Response.rescue do |res|
      ...
      model = ProductMeasurementUnit.new(create_params)
      model.save!
    end
  ...
  def self.update_by_params(params)
    ...
    response = Response.rescue do |res|
      ...
      model = ProductMeasurementUnit.find(model_id)
  ...
  def self.query_by_params(params)
    ...
    response = Response.rescue do |res|
      ...
      models = ProductMeasurementUnit.search_by_params(search_param).page(page).per(per)
    end
